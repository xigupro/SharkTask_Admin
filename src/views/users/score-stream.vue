<template>
  <div
    class="xg-main score-stream-page"
    v-loading="isListLoading">
    <div class="filter">
      <div class="info">{{nickName}} 的积分流水</div>
      <el-form :inline="true">
        <el-form-item>
    ...
    <div
      ...
      <el-table
        ...
        <el-table-column
          label="积分">
          <template slot-scope="scope">
            {{scope.row.is_income ? '+' : '-'}}{{scope.row.score}}
          </template>
        </el-table-column>
        <el-table-column
          prop="balance"
...
export default {
  ...
  methods: {
    ...
    async getStream() {
      ...
      this.list = [];
      const res = await UserProxy.scoreStream(params);
